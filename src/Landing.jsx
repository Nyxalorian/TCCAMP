...
function Landing({ onStart }) {
  ...
  return <main className="landing-page"><div className="landing-shell">
    ...
    <section className="landing-hero" id="inicio"><div className="landing-copy"><h1>Sua rotina de medicamentos, <em>organizada.</em></h1><p>PharmaLife te ajuda a lembrar, acompanhar e nunca mais esquecer seus medicamentos e lembretes importantes.</p><div className="landing-actions"><button className="landing-start" onClick={onStart}>Começar agora <b>→</b></button><button className="landing-link" onClick={() => goTo('sobre')}>Saiba mais⌄</button></div></div><div className="landing-visual" aria-hidden="true"><div className="visual-blob" /><div className="visual-note visual-done"><b>✓</b>Todos os<br />medicamentos<br />em dia!</div><div className="visual-note visual-next"><b>▣</b>Próximo lembrete<br /><strong>10:00</strong></div><img src={medicamentoHero} alt="" /></div></section>
